...
@hydra.main(config_path="conf", config_name="model_prior_MSigDB_zscore_static")
def main(cfg: DictConfig) -> None:
    ...
    #beta_list = cfg.training.beta_list
    ...
    run_id = wandb.run.id
    model_path = f"priorVAE_dynamic_model_{run_id}_MSigDB_zscore.pth"
