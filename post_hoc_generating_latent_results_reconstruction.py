...
if args.save_type == 'both':
    ...
    np.save(res_save_path+"latent_mu/"+save_name+"_latent_result.npy", mu_res)
    np.save(res_save_path+"latent_sigma/"+save_name+"_latent_sigma_result.npy", sigma_res)
    np.save(res_save_path+"reconstructed_value/"+save_name+"_reconstructed_result.npy", recon_res)
    np.save(res_save_path+"resampled_dim/"+save_name+"_z_result.npy", z_res)
