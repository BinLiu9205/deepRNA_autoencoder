...
class BootstrappingMSigDB:
    ...
    def swappedPathGeneVersion(self, sigName, geneList, order_file, swap_percentage=10):
        print("Running zScorePath with Replacing " + str(swap_percentage/100) + \
            "% top expressed genes with lowest expressed genes")
