...
with open('/mnt/dzl_bioinf/binliu/deepRNA/deepRNA/Experimental_update_revision/Hyperparameter_search_for_structure/training/conf/model_structure_sweep_betas.yaml', 'r') as file:
    sweep_config = yaml.safe_load(file)

@hydra.main(config_path="conf", config_name="model_structure_beta_search")
...
def run_sweep():
    ...
    wandb.agent(sweep_id, function=main, count = 12) #count=10)
